...
import { toText, interpolate, toConsole } from "./.fable/fable-library.3.2.9/String.js";
...
export function App_$ctor_Z64F8EF7E(appElement, triggerUpdate) {
    return new App(appElement, triggerUpdate);
}

export function App__get_CurrentSender(_) {
    return _.lastSender;
}
...
export function App__Run(_) {
    const element = _.triggerUpdate(void 0);
    void _.appElement.appendChild(element);
}

export function App__TriggerUpdate_B088534(_, sender) {
    _.lastSender = sender;
    toConsole(interpolate("Trigger update with sender: %P()", [sender]));
    const element = _.triggerUpdate(sender);
}
    ...
    return Gen_BaseBuilder__Delay_1505(TopLevelOperators_feed, () => {
        ...
        return new Gen$2(0, (state_10) => {
            ...
            const evalk_2 = (lastFeed, lastKState_3) => {
                ...
                const matchValue_4 = Gen_run((elem_1 = lastFeed, (evalk = ((mval, mstate, mleftovers, lastKState, isStopped) => {
...
export function button(content, click) {
    return Gen_BaseBuilder__Delay_1505(TopLevelOperators_loop, () => {
        const evalk_2 = (mval_3, mstate_3, mleftovers_3, lastKState_3, isStopped_3) => {
            ...
            const matchValue_2 = Gen_run((clickId = mval_3, (equals(App__get_CurrentSender(app()), clickId) ? click() : (void 0), (evalk = ((mval, mstate, mleftovers, lastKState, isStopped) => {
                let button_1;
...
export function view() {
    return Gen_BaseBuilder__Delay_1505(TopLevelOperators_loop, () => {
        const comp = () => Gen_BaseBuilder__Delay_1505(TopLevelOperators_feed, () => {
            const m_4 = new Init$1(1, () => 0);
            return new Gen$2(0, (state_4) => {
                let feedback_4, kstate_5, kstate_4;
                const getInitial = () => {
                    if (m_4.tag === 1) {
                        const f_4 = m_4.fields[0];
                        return f_4();
                    }
                    else {
                        const m_5 = m_4.fields[0];
                ...
                const evalk_2 = (lastFeed, lastKState_3) => {
                    let c, c_1, onClick, evalk, buildSkip, evalk_1, m_2;
                    const matchValue_1 = Gen_run((c = lastFeed, (c_1 = c, (onClick = (() => {
                        c_1 = ((c_1 + 1) | 0);
                        toConsole(interpolate("count = %P()", [c_1]));
                    }), (evalk = ((mval, mstate, mleftovers, lastKState, isStopped) => {
                        let div_1;
                        const matchValue = Gen_run((div_1 = mval, Gen_FeedBuilder__Return_Z2DCF3B94(TopLevelOperators_feed, new Feed_Emit$2(0, div_1, c_1))))(lastKState);
                        if (matchValue.tag === 1) {
                            const kvalues_1 = matchValue.fields[0];
                            return new Res$2(1, kvalues_1);
                        }
                    ...
                    }), (buildSkip = ((state_1) => (new FeedState$2(0, some(state_1), new FeedType$1(1)))), (evalk_1 = evalk, (m_2 = div([], button(text(toText(interpolate("Count = %P()", [c_1]))), onClick)), new Gen$2(0, (state_2) => {
                        let kstate_1, lastMState_2, isStopped_2, lastKState_2, lastMState_1, x, xs;
                        const evalmres = (mres, lastMState, lastKState_1, isStopped_1) => {
                            if (mres.tag === 1) {
                                if (isEmpty(mres.fields[0])) {
                                    return new Res$2(1, empty());
                                ...
                                const activePatternResult854 = Gen_$007CLoopStateToOption$007C(lastMState, mres.fields[1]);
                                const mstate_2 = activePatternResult854;
                                const state_3 = new BindState$3(mstate_2, lastKState_1, empty(), isStopped_1);
                                return new Res$2(0, empty(), buildSkip(state_3));
                            }
                            else {
                                const activePatternResult853 = Gen_$007CLoopStateToOption$007C(lastMState, mres.fields[1]);
                                const mleftovers_1 = tail(mres.fields[0]);
                        ...
                        return (state_2 == null) ? evalmres(Gen_run(m_2)(void 0), void 0, void 0, false) : (isEmpty(state_2.mleftovers) ? (state_2.isStopped ? (new Res$2(1, empty())) : ((kstate_1 = state_2.kstate, (lastMState_2 = state_2.mstate, evalmres(Gen_run(m_2)(lastMState_2), lastMState_2, kstate_1, false))))) : ((isStopped_2 = state_2.isStopped, (lastKState_2 = state_2.kstate, (lastMState_1 = state_2.mstate, (x = head(state_2.mleftovers), (xs = tail(state_2.mleftovers), evalk_1(x, lastMState_1, xs, lastKState_2, isStopped_2))))))));
                    })))))))))(lastKState_3);
                    if (matchValue_1.tag === 1) {
                        ...
                        const kstate_2 = matchValue_1.fields[1].fields[0];
                        ...
                        const kstate_3 = patternInput[1];
                        const feedback_3 = patternInput[0];
                        const state_5 = new BindState$3(feedback_3, kstate_3, empty(), false);
                        return new Res$2(0, kvalues_2, new LoopState$1(0, state_5));
                    }
                };
                return (state_4 == null) ? evalk_2(getInitial(), void 0) : (state_4.isStopped ? (new Res$2(1, empty())) : ((state_4.mstate != null) ? ((feedback_4 = value_3(state_4.mstate), (kstate_5 = state_4.kstate, evalk_2(feedback_4, kstate_5)))) : ((kstate_4 = state_4.kstate, evalk_2(getInitial(), kstate_4)))));
            });
        })();
        const evalk_7 = (mval_9, mstate_9, mleftovers_9, lastKState_10, isStopped_9) => {
            let c1, evalk_5, buildSkip_4, evalk_6, m_11;
            const matchValue_4 = Gen_run((c1 = mval_9, (evalk_5 = ((mval_6, mstate_6, mleftovers_6, lastKState_7, isStopped_6) => {
                let c2, evalk_3, buildSkip_2, evalk_4, m_8;
                const matchValue_3 = Gen_run((c2 = mval_6, (evalk_3 = ((mval_3, mstate_3, mleftovers_3, lastKState_4, isStopped_3) => {
                    let wrapper;
                    const matchValue_2 = Gen_run((wrapper = mval_3, ((wrapper.childNodes.length === 1) ? ((void wrapper.appendChild(c1), void wrapper.appendChild(c2))) : (void 0), Gen_LoopBuilder__Yield_1505(TopLevelOperators_loop, wrapper))))(lastKState_4);
                    if (matchValue_2.tag === 1) {
                        ...
                        const kstate_6 = matchValue_2.fields[1];
                        const newState = (kstate_7) => (new BindState$3(mstate_3, kstate_7, mleftovers_3, isStopped_3));
                        switch (kstate_6.tag) {
                            case 1: {
                                return new Res$2(0, kvalues_4, new LoopState$1(0, newState(lastKState_4)));
                            }
                            case 2: {
                                return new Res$2(0, kvalues_4, new LoopState$1(2));
                            }
                            default: {
                                const kstate_8 = kstate_6.fields[0];
                                return new Res$2(0, kvalues_4, new LoopState$1(0, newState(some(kstate_8))));
                            }
                        }
                    }
                }), (buildSkip_2 = ((state_6) => (new LoopState$1(0, state_6))), (evalk_4 = evalk_3, (m_8 = div([], Gen_initWith(() => document.createTextNode("---"))), new Gen$2(0, (state_7) => {
                    let kstate_9, lastMState_5, isStopped_5, lastKState_6, lastMState_4, x_1, xs_1;
                    const evalmres_1 = (mres_1, lastMState_3, lastKState_5, isStopped_4) => {
                        if (mres_1.tag === 1) {
                            ...
                            const activePatternResult854_1 = Gen_$007CLoopStateToOption$007C(lastMState_3, mres_1.fields[1]);
                            const mstate_5 = activePatternResult854_1;
                            const state_8 = new BindState$3(mstate_5, lastKState_5, empty(), isStopped_4);
                            return new Res$2(0, empty(), buildSkip_2(state_8));
                        }
                        else {
                            const activePatternResult853_1 = Gen_$007CLoopStateToOption$007C(lastMState_3, mres_1.fields[1]);
                    ...
                    return (state_7 == null) ? evalmres_1(Gen_run(m_8)(void 0), void 0, void 0, false) : (isEmpty(state_7.mleftovers) ? (state_7.isStopped ? (new Res$2(1, empty())) : ((kstate_9 = state_7.kstate, (lastMState_5 = state_7.mstate, evalmres_1(Gen_run(m_8)(lastMState_5), lastMState_5, kstate_9, false))))) : ((isStopped_5 = state_7.isStopped, (lastKState_6 = state_7.kstate, (lastMState_4 = state_7.mstate, (x_1 = head(state_7.mleftovers), (xs_1 = tail(state_7.mleftovers), evalk_4(x_1, lastMState_4, xs_1, lastKState_6, isStopped_5))))))));
                })))))))(lastKState_7);
                if (matchValue_3.tag === 1) {
                    ...
                    const kstate_10 = matchValue_3.fields[1];
                    const newState_1 = (kstate_11) => (new BindState$3(mstate_6, kstate_11, mleftovers_6, isStopped_6));
                    switch (kstate_10.tag) {
                        case 1: {
                            return new Res$2(0, kvalues_6, new LoopState$1(0, newState_1(lastKState_7)));
                        }
                        case 2: {
                            return new Res$2(0, kvalues_6, new LoopState$1(2));
                        }
                        default: {
                            const kstate_12 = kstate_10.fields[0];
                            return new Res$2(0, kvalues_6, new LoopState$1(0, newState_1(some(kstate_12))));
                        }
                    }
                }
            }), (buildSkip_4 = ((state_9) => (new LoopState$1(0, state_9))), (evalk_6 = evalk_5, (m_11 = comp(), new Gen$2(0, (state_10) => {
                let kstate_13, lastMState_8, isStopped_8, lastKState_9, lastMState_7, x_2, xs_2;
                const evalmres_2 = (mres_2, lastMState_6, lastKState_8, isStopped_7) => {
                    if (mres_2.tag === 1) {
                        if (isEmpty(mres_2.fields[0])) {
                            ...
                            return evalk_6(mval_8, lastMState_6, mleftovers_8, lastKState_8, isStopped_7);
                        }
                    }
                        ...
                        const state_11 = new BindState$3(mstate_8, lastKState_8, empty(), isStopped_7);
                        return new Res$2(0, empty(), buildSkip_4(state_11));
                    }
                    else {
                        ...
                        return evalk_6(mval_7, mstate_7, mleftovers_7, lastKState_8, isStopped_7);
                    }
                };
                return (state_10 == null) ? evalmres_2(Gen_run(m_11)(void 0), void 0, void 0, false) : (isEmpty(state_10.mleftovers) ? (state_10.isStopped ? (new Res$2(1, empty())) : ((kstate_13 = state_10.kstate, (lastMState_8 = state_10.mstate, evalmres_2(Gen_run(m_11)(lastMState_8), lastMState_8, kstate_13, false))))) : ((isStopped_8 = state_10.isStopped, (lastKState_9 = state_10.kstate, (lastMState_7 = state_10.mstate, (x_2 = head(state_10.mleftovers), (xs_2 = tail(state_10.mleftovers), evalk_6(x_2, lastMState_7, xs_2, lastKState_9, isStopped_8))))))));
            })))))))(lastKState_10);
            if (matchValue_4.tag === 1) {
                const kvalues_9 = matchValue_4.fields[0];
                return new Res$2(1, kvalues_9);
            }
            else {
                const kvalues_8 = matchValue_4.fields[0];
                const kstate_14 = matchValue_4.fields[1];
                const newState_2 = (kstate_15) => (new BindState$3(mstate_9, kstate_15, mleftovers_9, isStopped_9));
                switch (kstate_14.tag) {
                    case 1: {
                        return new Res$2(0, kvalues_8, new LoopState$1(0, newState_2(lastKState_10)));
                    }
                    case 2: {
                        return new Res$2(0, kvalues_8, new LoopState$1(2));
                    }
                    default: {
                        const kstate_16 = kstate_14.fields[0];
                        return new Res$2(0, kvalues_8, new LoopState$1(0, newState_2(some(kstate_16))));
                    }
                }
            }
        };
        const buildSkip_6 = (state_12) => (new LoopState$1(0, state_12));
        const evalk_8 = evalk_7;
        const m_14 = comp();
        return new Gen$2(0, (state_13) => {
            let kstate_17, lastMState_11, isStopped_11, lastKState_12, lastMState_10, x_3, xs_3;
            const evalmres_3 = (mres_3, lastMState_9, lastKState_11, isStopped_10) => {
                if (mres_3.tag === 1) {
                    if (isEmpty(mres_3.fields[0])) {
                        ...
                        return evalk_8(mval_11, lastMState_9, mleftovers_11, lastKState_11, isStopped_10);
                    }
                }
                    ...
                    const state_14 = new BindState$3(mstate_11, lastKState_11, empty(), isStopped_10);
                    return new Res$2(0, empty(), buildSkip_6(state_14));
                }
                else {
                    ...
                    return evalk_8(mval_10, mstate_10, mleftovers_10, lastKState_11, isStopped_10);
                }
            };
            return (state_13 == null) ? evalmres_3(Gen_run(m_14)(void 0), void 0, void 0, false) : (isEmpty(state_13.mleftovers) ? (state_13.isStopped ? (new Res$2(1, empty())) : ((kstate_17 = state_13.kstate, (lastMState_11 = state_13.mstate, evalmres_3(Gen_run(m_14)(lastMState_11), lastMState_11, kstate_17, false))))) : ((isStopped_11 = state_13.isStopped, (lastKState_12 = state_13.kstate, (lastMState_10 = state_13.mstate, (x_3 = head(state_13.mleftovers), (xs_3 = tail(state_13.mleftovers), evalk_8(x_3, lastMState_10, xs_3, lastKState_12, isStopped_11))))))));
        });
    })();
}
...
(function () {
    ...
    app(App_$ctor_Z64F8EF7E(document.querySelector("#app"), (_arg1) => value_3(Gen_Evaluable$1__Evaluate(evaluableView))), true);
    App__Run(app());
})();
